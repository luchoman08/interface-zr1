...
function extractStudentResultFromTr(el: CheerioElement): ResultadoBusquedaEstudiante {
...
export function extractStudentsResults(html: any /** string */): ResultadoBusquedaEstudiante[] {
    var results: ResultadoBusquedaEstudiante[] = [];
